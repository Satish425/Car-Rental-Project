        ...
        <form className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl' onSubmit={onSubmitHandler}>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
            ...
            <div className='flex flex-col w-full'>
              ...
              <select onChange={e=>setCar({...car,transmission:e.target.fuel_type})} value={car.fuel_type} className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'>
                <option value="">Select a fuel_type</option>
                <option value="Gas">Gas</option>
                <option value="Diesel">Diesel</option>
                <option value="Petrol">Semi-Automatic</option>

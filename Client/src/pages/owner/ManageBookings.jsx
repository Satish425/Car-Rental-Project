          ...
          <table className='w-full border-collapse text-left text-sm text-gray-600'>
            <thead className='text-gray-500'>
              <tr>
                ...
                <th className='p-3 font-medium max-nd:hidden'>Date Range</th>
              ...
              {bookings.map((booking,index)=>(
                <tr key={index} className='border-t border-borderColor text-gray-600'>
                  ...
                  <td className='p-3 max-md:hidden'>
                    <p className='font-medium max-md:hidden'>{booking.pickupDate.split('T')[0]} To {booking.returnDate.split('T')[0]}</p>
                  </td>
                  ...
                  <td className='p-3'>
                    {booking.status === 'pending' ? (<select value={booking.status} className='px-2 py-1.5 mt-1 text-gray-500 border border-borderColor rounded-md outline-none'>

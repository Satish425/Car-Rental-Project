  ...
  return (
    ...
    <div >
        {bookings.map((booking,index)=>(
          <div key = {booking._id} className='grid grid-cols-1 md:grid-cols-4 gap-6 p-6 border-borderColor rounded-lg mt-5 first:mt-12 shadow-lg hover:-translate-y-1 transition-all duration-500 '>
            {/* car Image and info */}
            ...
            <div className='md:col-span-2'>
              ...
              <div className='flex items-start gap-2 mt-3'>
                ...
                <div>
                  ...
                  <p className='font-medium'>{booking.pickupDate.split('T')[0]} - {booking.returnDate.split('T')[0]}</p>
                </div>
              </div>

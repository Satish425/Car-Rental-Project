  ...
  return (
    ...
    <div >
        {bookings.map((booking,index)=>(
          ...
          key = {booking._id} className='grid grid-cols-1 md:grid-cols-4 gap-6 p-6 border-borderColor rounded-lg mt-5 first:mt-12 shadow-lg hover:-translate-y-1 transition-all duration-500 '>
            {/* car Image and info */}

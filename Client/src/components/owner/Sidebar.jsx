...
const Sidebar = () => {
  ...
  return (
    <div className='relative min-h-screen md:flex flex-col items-center pt-8 mx-w-13 md:max-w-60 w-full h-full border-r border-borderColor text-sm'>
        ...
        {image && (<button onClick={updateImage}className='absolute top-0 right-0 flex p-2 gap-1 bg-primary/10 text-primary cursor-pointer' >Save <img src={assets.check_icon} width={13} alt="" /></button>)}

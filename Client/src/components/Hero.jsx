    ...
    bg-light text-center'>
        ...
        <div className='flex flex-col md:flex-row items-start md:items-center gap-10 '>
         ...
         <button className='flex items-center justify-center gap-1 px-9 py-3
            max-sm:mt-4 bg-primary hover:bg-primary-dull text-white rounded-full cursor-pointer'> <img src={assets.search_icon} alt="" className='brightness-300'/> Search</button>
        </form>
